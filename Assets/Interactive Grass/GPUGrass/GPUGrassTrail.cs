...
{
	public class GPUGrassTrail : MonoBehaviour
	{
		[Header("Grass")]
		...
		void RoundDisplacement()
		{
			Vector3 rayOrigin = transform.TransformPoint(m_Offset);
			...
			m_Trail.Apply();
			if (m_Grass)
				m_Grass.material.SetTexture("_TrailTex", m_Trail);
		}
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
